...
st.set_page_config(page_title="N.I.S. Baldanullah's Portofolioo ", layout="wide")
...
if selected_nav == "About Me":
    ...
    st.markdown("""
        <div class="card">
            ...
            <p>
                Since childhood, I have grown up in an office environment that introduced me to computers, the internet, technology, and software. This experience sparked my interest in studying computer science. Today, data is considered a highly valuable asset, even more valuable than fuel. This belief has led me to focus on data, machine learning, and artificial intelligence because I believe these fields can transform society and make life easier.

I am confident that the skills I have now, and those I will continue to develop, can help solve various challenges faced by companies. I want to be part of the solution for data-related problems and use technology to improve efficiency and innovation. With expertise in this field, I believe I can make a significant contribution to the success of companies and address data-related challenges.

Through dedication and continuous self-improvement, I am sure I can provide innovative and effective solutions to overcome challenges. The skills and knowledge I have will allow me to make a positive impact on both companies and society. Together, we can create a better future by harnessing the great potential of data, machine learning, and artificial intelligence.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div class="contact-card">
            ...
            <a href="https://www.instagram.com/bldnnnnn/" target="_blank">
