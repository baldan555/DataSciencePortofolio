...
def main():
    ...
    st.info("""
    **Information**:
    - The dataset used in this application is the NYC Taxi dataset, u can see at (https://www.kaggle.com/datasets/julienjta/nyc-taxi-traffic).
    - You can see the algorithm model used in this app at (https://www.kaggle.com/code/nissbaldanullah/lungcancerprediction/notebook)**.
