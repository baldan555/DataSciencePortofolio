...
def main():
    ...
    st.info("""
        **Information**:
        ...
        - The algorithm model used in this app is Random Forest based on the best accuracy modelling you can see at (https://www.kaggle.com/code/nissbaldanullah/manufacturedefectpredict)**.
