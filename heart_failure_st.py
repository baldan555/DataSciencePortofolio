...
def main():
    ...
    st.info("""
        **Information**:
        ...
        - The dataset used in this application is the Heart Failure Dataset from (https://www.kaggle.com/datasets/fedesoriano/heart-failure-prediction).
        - You can choose and compare the algorithm model used in this app by the side bar).
        - See the modelling at (https://www.kaggle.com/nissbaldanullah/heartfailureprediction)**.
